 ...
 *
 * PDF generation uses mPDF (already vendored under /aetherV2/vendor/).
 */

require_once dirname(__DIR__, 2) . '/api/pdf-receipt.php'; // ensures vendor autoload exists somewhere
