...
function renderShell() {
  ...
  const userName = me?.name || me?.full_name || me?.username || 'User';
    ...
    <div class="shell">
      ...
      <main class="content">
        <div class="topbar">
          ...
          <button class="theme-toggle" id="erp-theme-toggle" data-testid="erp-theme-toggle" title="Toggle light/dark"></button>
        </div>
  ...
  if (window.AetherTheme) {
    window.AetherTheme.bindButton(document.getElementById('erp-theme-toggle'));
  }
